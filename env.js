 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.expo-ownerstarter.staging
 */

const BUNDLE_ID = 'com.expo-ownerstarter'; // ios bundle id
const PACKAGE = 'com.expo-ownerstarter'; // android package name
const NAME = 'expo-ownerStarter'; // app name
